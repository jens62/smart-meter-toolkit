    ...
    def run(self):
        ...
        try:
            ...
            if not result:
                ...
                self.logger.info(f"Processing completed successfully. Output files: {result.get('cms_files', [])}")
                self.logger.info(f"Processing completed successfully. Output : {result}")
